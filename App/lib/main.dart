...
class _MyAppState extends State<MyApp> {
  ...
  _togglemute() async {
    ...
    final response = await http.get(url);
    setState(() {
      _muteMusicSelected = !_muteMusicSelected;
    });
  }
        ...
        child: Container(
          decoration: BoxDecoration(
            image: DecorationImage(
                image: ExactAssetImage("assets/24866.jpg"), fit: BoxFit.cover),
          ),
          child: Column(
            children: <Widget>[
              Padding(
                ...
                child: Row(
                    ...
                    children: <Widget>[
                      IconButton(
                          ...
                          color: _muteMusicSelected ? Colors.red : Colors.white,
                          iconSize: 30.0),
                      IconButton(
                          onPressed: () async {
                      ...
                      IconButton(
                          onPressed: () async {
                            String ip = await prompt(
                              context,
                              title: Text('Enter host machine IP'),
                            );
                            setState(() {
                              currentIP = ip;
                            });
